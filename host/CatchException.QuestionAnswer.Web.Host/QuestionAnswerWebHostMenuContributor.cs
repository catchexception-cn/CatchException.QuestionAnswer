...
public class QuestionAnswerWebHostMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public QuestionAnswerWebHostMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<QuestionAnswerResource>();
